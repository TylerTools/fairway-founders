...
| @claude-gameplay | Gameplay/scoring: `app/leaderboard/*`, `lib/{scoring,course-holes}.ts`, `app/actions/{scores,groups,test-game,holes}.ts`, `app/admin/test/*`, `components/{PlayNowBall,BackToGameBall}.tsx` | active — live test-game flow |
| @claude-onboarding | Sign-up onboarding: `components/OnboardingWizard.tsx`, `app/actions/onboarding.ts`, `onboarded_at` gate in `app/layout.tsx` | Phase 1 shipped; Phase 2 (surface new fields in /me, roster, pairing) handed to @claude-members |
